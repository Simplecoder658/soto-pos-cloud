...
export default function App() {
  ...
  return (
    <div className="flex h-screen bg-orange-50 overflow-hidden font-sans">
      {/* Sidebar Laptop */}
      <div className="hidden md:flex flex-col items-center w-24 bg-orange-600 py-8 gap-8 shadow-2xl text-white">
      ...
      <div className={`fixed md:relative top-0 right-0 h-full w-full md:w-96 bg-white shadow-2xl transition-all duration-300 transform ${showCartMobile ? 'translate-x-0' : 'translate-x-full md:translate-x-0'} z-50 flex flex-col`}>
        ...
        <div className="flex-1 overflow-y-auto px-4 space-y-4">
          {cart.length === 0 ? (
            ...
            <div key={i} className="flex justify-between items-center group border-b border-orange-50 pb-3">
